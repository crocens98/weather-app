...
class JsonConverterTest {
  ...
  void toObject_hotel() {
    ...
    TemperatureRecord temperatureRecord1 = TemperatureRecord.builder().build();
    temperatureRecord1.setDay("2017-09-04");
    temperatureRecord1.setTemperature(24.123);

    TemperatureRecord temperatureRecord2 = TemperatureRecord.builder().build();
    ...
    Hotel expected = Hotel.builder().build();
  ...
  void toObject_weather() {
    ...
    Weather expected = Weather.builder().build();
